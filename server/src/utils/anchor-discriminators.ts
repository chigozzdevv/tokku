...
export const DISCRIMINATORS = {
  ...
  REFUND_BET: getAnchorDiscriminator("refund_bet"),
  ...
  ER_REVEAL_OUTCOME_NUMERIC: getAnchorDiscriminator(
    "er_reveal_outcome_numeric",
  ),
  ER_REVEAL_OUTCOME_SHAPE: getAnchorDiscriminator("er_reveal_outcome_shape"),
  ER_REVEAL_OUTCOME_PATTERN: getAnchorDiscriminator(
    "er_reveal_outcome_pattern",
  ),
  ER_REVEAL_OUTCOME_ENTROPY: getAnchorDiscriminator(
    "er_reveal_outcome_entropy",
  ),
  ER_REVEAL_OUTCOME_COMMUNITY: getAnchorDiscriminator(
    "er_reveal_outcome_community",
  ),
  DELEGATE_ROUND: getAnchorDiscriminator("delegate_round"),
  COMMIT_ROUND: getAnchorDiscriminator("commit_round"),
  COMMIT_AND_UNDELEGATE_ROUND: getAnchorDiscriminator(
