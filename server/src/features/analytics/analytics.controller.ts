...
export class AnalyticsController {
  ...
  getTrendingMarkets = asyncHandler(
    async (request: FastifyRequest, reply: FastifyReply) => {
  ...
  getRoundPerformanceMetrics = asyncHandler(
    async (_request: FastifyRequest, reply: FastifyReply) => {
