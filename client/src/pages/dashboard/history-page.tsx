...
export function HistoryPage() {
  const [buckets, setBuckets] = useState<BetBuckets>({
    won: [],
    lost: [],
    refunded: [],
  });
              ...
              <div key={key} className="card dashboard-history-card">
                ...
                {bets.length === 0 ? (
                  <div className="dashboard-empty">
                    No {STATUS_LABELS[key].toLowerCase()} yet.
                  </div>
                ) : (
                        ...
                        <li key={bet.id}>
                          <div className="dashboard-history-row">
                            <div>
                              ...
                              <div>
                                <small className="dashboard-round-stat-label">
                                  ID:
                                </small>{" "}
