  ...
  switch ((round as any).market?.type) {
    case "PICK_RANGE": {
      const partitions = Math.max(
        1,
        Math.min(20, Math.floor(asNumber(config.partitionCount, 4))),
      );
      ...
      options.push(
        {
          ...
          coverage: "50/100",
          selection: { type: "parity", value: "even" },
        },
        {
          id: "odd",
          label: "Odd",
          odds: fromEqualBins(2),
          coverage: "50/100",
          selection: { type: "parity", value: "odd" },
        },
      );
      break;
    case "LAST_DIGIT":
      ...
      options.push(
        {
          ...
          coverage: "12/72",
          selection: { type: "shape", shape: 255, color: 0, size: 255 },
        },
        {
          id: "shape-color",
          label: "Shape + Color",
          ...
          coverage: "3/72",
          selection: { type: "shape", shape: 0, color: 0, size: 255 },
        },
        {
          id: "full",
          label: "Exact Match",
          ...
          coverage: "1/72",
          selection: { type: "shape", shape: 0, color: 0, size: 0 },
        },
      );
      break;
    case "JACKPOT":
