...
function fromEqualBins(n: number, ef: number) {
  return to2(n * ef);
}
  ...
  const data: MarketData[] = [
    {
      ...
      options: [
        ...
        },
        {
          id: "r2",
          label: "1-25",
          description: "25 numbers",
          odds: fromEqualBins(4, rangeEf4),
          coverage: "25/100",
          trend: "neutral",
          trendValue: "+2%",
          popularity: 45,
        },
        {
          ...
          odds: fromEqualBins(10, rangeEf10),
          coverage: "10/100",
          trend: "cold",
          trendValue: "-8%",
          popularity: 23,
        },
        {
          ...
          odds: fromProbability(5, 100, rangeEfAny),
          coverage: "5/100",
          trend: "hot",
          trendValue: "+18%",
          popularity: 52,
        },
        {
          ...
          odds: fromEqualBins(100, rangeEfAny),
          coverage: "1/100",
          trend: "hot",
          trendValue: "+24%",
          popularity: 34,
    ...
    },
    {
      ...
      options: Array.from({ length: 5 }, (_, i) => {
        ...
        return {
          id: `d${lab}`,
          label: lab,
          description: `Ends in ${lab}`,
          odds: fromEqualBins(10, lastDigitEf),
          coverage: "10/100",
          trend: i === 0 || i === 4 ? "hot" : i === 2 ? "cold" : "neutral",
          trendValue:
            i === 4 ? "+22%" : i === 0 ? "+18%" : i === 2 ? "-12%" : "+5%",
          popularity: [34, 28, 19, 31, 67][i],
        } as BetOption;
      }),
    },
    {
      ...
      options: [
        {
          id: "j1",
          label: "Exact Number",
          description: "Pinpoint accuracy required",
          odds: fromEqualBins(100, jackpotEf),
          coverage: "1/100",
          trend: "hot",
          trendValue: "+31%",
          popularity: 92,
      ...
      options: [
        {
          id: "e1",
          label: "TEE Wins",
          description: "Trusted Execution",
          odds: fromEqualBins(3, entropyEf),
          coverage: "33/100",
          trend: "hot",
          trendValue: "+19%",
          popularity: 71,
        },
        {
          id: "e2",
          label: "Chain Wins",
          description: "Blockchain entropy",
          odds: fromEqualBins(3, entropyEf),
          coverage: "33/100",
          trend: "neutral",
          trendValue: "+6%",
      ...
      options: [
        {
          ...
          odds: fromProbability(patternCounts[0], 1000, patternEf),
          coverage: "168/1000",
          trend: "hot",
          trendValue: "+16%",
          popularity: 52,
        },
        {
          ...
          odds: fromProbability(patternCounts[1], 1000, patternEf),
          coverage: "10/1000",
          trend: "neutral",
          trendValue: "+3%",
          popularity: 41,
        },
        {
          ...
          odds: fromProbability(patternCounts[2], 1000, patternEf),
          coverage: "29/1000",
          trend: "cold",
          trendValue: "-5%",
          popularity: 28,
        },
        {
          id: "pat4",
          label: "Palindrome",
          description: "Reads same both ways",
          odds: fromProbability(patternCounts[4], 1000, patternEf),
          coverage: "73/1000",
          trend: "hot",
          trendValue: "+11%",
          popularity: 35,
      ...
      options: [
        {
          ...
          odds: fromProbability(12, 72, shapeEf),
          coverage: "12/72",
          trend: "hot",
          trendValue: "+14%",
          popularity: 64,
        },
        {
          ...
          odds: fromProbability(3, 72, shapeEf),
          coverage: "3/72",
          trend: "neutral",
          trendValue: "+1%",
          popularity: 47,
        ...
        {
          id: "sc3",
          label: "Small Green Circle",
          description: "All attributes",
          odds: fromProbability(1, 72, shapeEf),
          coverage: "1/72",
          trend: "hot",
          trendValue: "+9%",
          popularity: 55,
      ...
      options: [
        {
          ...
          odds: fromProbability(1 + 8 + 28, 256, communityEf),
          coverage: "37/256",
          trend: "hot",
          trendValue: "+18%",
          popularity: 81,
        },
        {
          ...
          odds: fromProbability(1 + 8, 256, communityEf),
          coverage: "9/256",
          trend: "neutral",
          trendValue: "+12%",
          popularity: 62,
        },
        {
          ...
          odds: fromProbability(1, 256, communityEf),
          coverage: "1/256",
          trend: "hot",
          trendValue: "+4%",
          popularity: 39,
...
export function MarketsSection() {
  ...
  const activeMarket = useMemo(
    () =>
      (marketsData || buildMarketsData([])).find((m) => m.type === activeTab),
  ...
  return (
    <Section id="markets">
      <div className="container">
        <SectionHeader
          title="Markets"
          sub="Explore odds and betting options across all market types"
        />

        {/* Tabs row */}
        <div className="markets-header-row">
          <nav
            className="markets-tabs-horizontal"
            role="tablist"
            ...
            {activeMarket && (
              <>
                <div style={{ marginBottom: "1.5rem" }}>
                  ...
                  <p
                    className="meta"
                    style={{ margin: "0.5rem 0 0 0", fontSize: "0.95rem" }}
                  >
